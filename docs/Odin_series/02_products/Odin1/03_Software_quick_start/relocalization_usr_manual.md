...
![定位成功](../../../01_series/assets/img/relocalization.png)
...
![Mindcloud导入.lx文件流程图](../../../01_series/assets/img/input_olx.PNG)

- 等待处理完成

![](../../../01_series/assets/img/waitging.PNG)

- 保存.pcd点云数据

![](../../../01_series/assets/img/save_pcd.PNG)

- 保存.bin地图数据

![](../../../01_series/assets/img/save_bin.PNG)
...
|终端视图|save_map|保存结果|
| :---: | :---: | :---: |
|![终端视图](../../../01_series/assets/img/terminal_view1.png)|![map](../../../01_series/assets/img/save_map.png)| ![result](../../../01_series/assets/img/bin.png)|

### 9.3.5 直接从Odin slam模式获取的.bin文件转.pcd文件

借助MindCloud软件将.bin文件转成.pcd文件

![bin_to_pcd](../../../01_series/assets/img/bin_to_pcd.png)
...
![地图显示](../../../01_series/assets/img/show_pcd.png)
